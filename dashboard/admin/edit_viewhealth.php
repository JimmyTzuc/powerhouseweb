...
<head>
    ...
    <title>POWER HOUSE Gym| Admin </title>
    ...
    <body class="page-body  page-fade">
		...
		<hr />
			...
			?>
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Hidratación :</label>					
						<div class="col-sm-5">
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Musculatura :</label>					
						<div class="col-sm-5">
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Huesos :</label>					
						<div class="col-sm-5">
